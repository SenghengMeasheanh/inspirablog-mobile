...
export default function OTPCode() {
    ...
    return (
        <YStack px="$4">
            ...
            <Paragraph fontFamily="$mono">Please enter the OTP sent to your email address.</Paragraph>
            ...
            <Button onPress={() => router.push('/auth/reset-password')} color="white" bg="$accent1" mt="$6" fontFamily="$mono">
                Continue
            </Button>
